...
@Component({
  selector: 'app-accept-req',
  standalone: true,
  imports: [RouterLink,CommonModule,RouterOutlet],
  templateUrl: './accept-req.component.html',
  styleUrls: ['./accept-req.component.css','../dashboard-home.component.css']
})
...
ExtraItem=0
  constructor(private _GetrequestsService: GetrequestsService,private _AuthService: AuthService) {
    this.getRequests(0,10,1)
  }
  getRequests(skip:any=0,take:any=10,status:any=1){
